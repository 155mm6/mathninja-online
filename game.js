...
class GameManager {
            ...
            <div class="screen menu-screen active">
                <div class="menu-content">
                    ...
                    <div class="grade-select">
                        <button class="grade-btn" data-grade="1">1 класс</button>
                        <button class="grade-btn" data-grade="2">2 класс</button>
                        <button class="grade-btn" data-grade="3">3 класс</button>
                        <button class="grade-btn" data-grade="4">4 класс</button>
                    </div>
                </div>
            </div>
        `;
    ...
    renderIslandCard(island) {
        ...
        const maxStars = (LEVELS_PER_ISLAND + 1) * 3;
        const starDisplay = stars > 0 ? '⭐'.repeat(Math.min(stars, 9)) : '🔒';
                    ...
                    <div class="question-box">
                        ...
                        ${currentAnswer ? `
                            <button class="result-btn primary" data-action="next-question">
                                ${this.currentQuestion === this.levelQuestions.length - 1 ? 'Готово' : 'Дальше'}
                            </button>
                        ` : ''}
                    </div>
                </div>
    ...
    getHint(question) {
        const hints = {
            ...
            'multiplication': 'Подумай: это то же самое, что несколько групп одинакового количества',
        ...
        return `
            <div class="screen boss-screen active">
                <div class="boss-container">
                    ...
                    <div style="color: white; font-weight: bold; margin-bottom: 2rem;">HP: ${this.bossHP}/${this.bossMaxHP}</div>
                    ...
                    <div class="question-box" style="color: var(--dark);">
                        ...
                        ${currentAnswer ? `
                            <button class="result-btn primary" data-action="next-question">
                                ${this.currentQuestion === this.levelQuestions.length - 1 ? 'Битва окончена!' : 'Дальше'}
                            </button>
                        ` : ''}
                    </div>
                </div>
        ...
        return `
            <div class="screen result-screen active">
                <div class="result-container">
                    ...
                    <div style="font-size: 1.3rem; margin-bottom: 1rem;">Правильных ответов: ${correctCount}/${totalCount}</div>
                    ...
                    <button class="result-btn" data-action="island-menu">Вернуться на карту</button>
                </div>
            </div>
        `;
    }
                ...
                <div class="map-container">
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 2rem; width: 100%;">
                        ${Array.from({length: LEVELS_PER_ISLAND + 1}, (_, i) => {
                            ...
                            return `
                                <button style="padding: 2rem; border: 3px solid var(--primary); border-radius: 15px; background: white; font-size: 1.3rem; font-weight: bold; cursor: pointer; transition: all 0.3s;" data-level="${levelNum}" data-island-menu="${islandId}">
